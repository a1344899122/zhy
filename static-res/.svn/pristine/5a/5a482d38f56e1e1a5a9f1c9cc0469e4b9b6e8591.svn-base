	...
	<div class="pageContainer">
		...
		<div class="crumbs">
			<ol class="breadcrumb">
				...
				<li ><a href="#"  class="active" title="">页面元素</a></li>
			</ol>
		</div>
		<!-- 内容 -->
		<div class="mainContent">
			...
			<div class="panelBox">
						    ...
						    <tr>
						      ...
						      <td width="40%">
						      	<div class="input-radio" style="width:60px">
						      		<input type="radio" name="sex" value="" id="aa" disabled checked><span>男</span>
						      	</div>
						      ...
						      <td width="40%">
						      	<input type="text" size="20" onfocus="ws.tools.date({dateFmt:'yyyy-MM-dd'});">
						      </td>
						    </tr>
						    <tr>
						      ...
						      <td width="40%">
						     	 <div class="input-checkbox" style="width:60px">
						      		<input type="checkbox" name="" value="" disabled checked>
						      		<span>篮球</span>
						      	 </div>
						      	 <div class="input-checkbox" style="width:60px">
				...
				<div class="panelContent">
					<div class="saveTable">
						<table class="table table-dashed-line">
							<tr>
						      <td align="right" width="20%">年度：</td>
						      <td>
						      	<input type="text" size="20" onfocus="ws.tools.date({dateFmt:'yyyy'});">
						      </td>
						    </tr>
						    <tr>
						    ...
						    <tr>
						      ...
						      <td>
						      	<input type="text" size="20" onfocus="ws.tools.date({dateFmt:'yyyy-MM-dd HH:mm:ss'});">
						      </td>
						    </tr>
						    <tr>
						      <td align="right" width="20%">日期（周期）：</td>
						      <td>
					...
					<div class="tabbable-custom">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab_1_1">
								<iframe id="tabiframe" src='<%=request.getContextPath()%>/js/ws-ui/V4.0/demo/edit/tabPage_edit.jsp' width="100%" height="500px" frameborder="no" border="0" scrolling="yes" allowtransparency="yes"></iframe>
							</div>
			...
			<div class="panelBox">
				...
				<div class="panelContent">
					...
					<!-- 没有表头的table，且table没有边框线，里面的线条是实线 -->
					<div class="secondTitle">6、没有表头的table，且table没有边框线，里面的线条是实线（table table-no-borderLine-solid）</div>
					<div class="saveTable">
						<table class="table table-no-borderLine-solid">
						  <tbody>
						    <tr>
						      <td align="right" width="10%">姓名：</td>
						      <td colspan="5">
					...
					<!-- 没有表头的table，且table没有边框线，里面的线条是虚线 -->
					<div class="secondTitle">7、没有表头的table，且table没有边框线，里面的线条是虚线（table table-no-borderLine-dashed）</div>
					<div class="saveTable">
						<table class="table table-no-borderLine-dashed">
						  <tbody>
						    <tr>
						      <td align="right" width="10%">姓名：</td>
						      <td colspan="5">
