	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#submitBtn1").click(function(){
				top.$('body').modalDialog().show({
					id:"editModelDialog3",
					url:'../UI4.0/pages/edit/dialogPage_edit3.jsp',
					title: "编辑页面",
	...
	<div class="pageContainer">
						...
						<form action="">
							<table class="table table-dashed-line">
							    ...
							    <tr>
							      ...
							      <td>
							      	<IFRAME ID="eWebEditor1" SRC="http://127.0.0.1:8080/static-res/js/net/ueditor1.4.3.3/base.html"  FRAMEBORDER="0" SCROLLING="no" WIDTH="100%" HEIGHT="450"></IFRAME>										
							      </td>
							    </tr>
							</table>
						</form>
		...
		<div class="footerButtonBox">
			<div class="buttonConent">
				...
				<button id="submitBtn1" type="button" class="btn btn-main">打开下下一个模态框</button>
