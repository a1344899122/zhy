...
<body>
	<div class="pageContainer">
		...
		<div class="third-menu">
			<a href="<%=request.getContextPath()%>/js/ws-ui/V6.0/demo/third_menu.jsp">查询列表</a>
			<a class="active" href="<%=request.getContextPath()%>/js/ws-ui/V6.0/demo/third_menu2.jsp">弹出列表</a>
