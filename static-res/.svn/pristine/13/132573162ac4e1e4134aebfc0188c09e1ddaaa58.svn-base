			...
			<div class="left-content" id="left-content">
				...
				<nav class="sidebar" id="aaa">
					<ul class="nav">
						...
						<!-- 二级菜单 -->
						<li>
							<a data-toggle="collapse"  href="#collapseOne1"><i class="fa fa-caret-right"></i><i class="glyphicon glyphicon-calendar"></i>会议预约</a>
						...
						<!-- 二级菜单 -->
						<li>
							<a data-toggle="collapse"  href="#collapseOne2"><i class="fa fa-caret-right"></i><i class="fa fa-pencil-square-o"></i>会议考核</a>
						...
						<!-- 二级菜单 -->
						<li>
							<a data-toggle="collapse"  href="#collapseOne3"><i class="fa fa-caret-right"></i><i class="fa fa-cog"></i>基础设置</a>
							<ul class="nav panel-collapse collapse" id="collapseOne3">
								...
								<li>
									<a data-url="<%=request.getContextPath()%>/js/ws-ui/V6.0/demo/list/dialog.jsp">单位信息维护</a>
								</li>
								<li>
						...
						<!-- 二级菜单 -->
						<li>
							<a data-toggle="collapse"  href="#collapseOne5"><i class="fa fa-caret-right"></i><i class="glyphicon glyphicon-th-list"></i>会议查询</a>
						...
						<li>
							<a data-toggle="collapse"  href="#collapseOne6"><i class="fa fa-caret-right"></i><i class="fa fa-bar-chart"></i>会议统计</a>
						...
						<li>
							<a data-url="<%=request.getContextPath()%>/js/ws-ui/V6.0/demo/base.jsp"><i class="glyphicon glyphicon-volume-up"></i>通知公告</a>
						</li>
						
						<li>
							<a data-url="<%=request.getContextPath()%>/js/ws-ui/V6.0/demo/base.jsp"><i class="glyphicon glyphicon-book"></i>知识库</a>
						</li>
						
						
						<!-- 三级菜单 -->
						<li>
							<a data-toggle="collapse"  href="#collapseThree"><i class="fa fa-caret-right"></i><i class="fa fa-cogs"></i>系统管理</a>
