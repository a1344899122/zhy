...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			//初始化表格
			table.initFirstTable(); 
			$("#fristTable").resizableColumns({});
			
			//初始化表格
			table.initSecondTable(); 
			$("#secondTable").resizableColumns({});
