					...
					<div class="tabbable-custom">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab_1_1">
								<iframe id="tabiframe" src='<%=request.getContextPath()%>/js/ws-ui/V5.0/demo/edit/tabPage_edit.jsp' width="100%" height="500px" frameborder="no" border="0" scrolling="yes" allowtransparency="yes"></iframe>
							</div>
