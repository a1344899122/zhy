...
(function(component) {
	 ...
	 * html_source   凌乱的html
	 * indent_size   空格缩进量
	 * indent_character      缩进字符
	 * max_char      超过最大字符数换行
	 */
	component.style_html=function(html_source, indent_size, indent_character, max_char){
		  ...
		  function Parser() {
		    ...
		    this.get_token = function () { //initial handler for token-retrieval
		      ...
		      if (this.last_token === 'TK_TAG_SCRIPT') { //check if we need to format javascript
		        ...
		        token = ws.component.js_beautify(temp_token, this.indent_size, this.indent_character, this.indent_level); //call the JS Beautifier
